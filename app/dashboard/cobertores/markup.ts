...
<div class="app">
  ...
  <div class="form-panel">
    ...
    <div class="tab-content" id="tab-items">
      ...
      <div style="font-size:10.5px;color:var(--muted);margin:-6px 0 10px;">Estos tres precios son la base compartida por todo el equipo (se guardan solos y viajan en el Exportar/Importar catálogo). No son por presupuesto.</div>

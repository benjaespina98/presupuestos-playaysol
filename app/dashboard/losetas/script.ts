...
function resetAll(){
  ...
  document.getElementById('solar').value = '0.5';
  document.getElementById('opuesto').value = '0.5';
  document.getElementById('lateral1').value = '0.5';
  document.getElementById('lateral2').value = '0.5';
  ...
  document.getElementById('solarHumedoAncho').value = '1.0';
  ...
  document.getElementById('cantLuces').value = '2';

...
export function CobertorCalculadora({
  ...
  const textosBase = useMemo(() => leerTextosCompartidos(catalogo, TEXTOS_POR_DEFECTO_COBERTORES), [catalogo]);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="grid grid-cols-1 gap-6 pb-20 sm:pb-0 lg:grid-cols-[minmax(0,1fr)_420px] print:block print:pb-0">
      <VistaPreviaMovil
        ...
        <EditorTextosCompartidos tipo="cobertores" textos={textos} onGuardado={setTextosOverride} />

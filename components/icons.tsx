// Set mínimo de íconos de línea (estilo Feather/Lucide) para las acciones del portal.
// Trazo simple y consistente en vez de emoji — se ven distinto según SO/navegador y
// no calzan con una identidad "estudio de arquitectura" prolija.
...
export function IconCloudUpload({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconFileText({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
